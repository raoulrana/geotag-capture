'use strict';
/* Vendored from npm 'open-location-code' (Apache-2.0) with a browser shim.
   Official reference implementation — do not hand-edit the core. */
(function () {
  var module = { exports: {} };
...
exports.OpenLocationCode = OpenLocationCode;
  var _olc = new module.exports.OpenLocationCode();
  var api = { encode: function (lat, lon, len) { return _olc.encode(lat, lon, len); } };
  if (typeof window !== 'undefined') window.OpenLocationCode = api;
  if (typeof globalThis !== 'undefined') globalThis.__olc = api;
})();
